...
public class CustomUserAggUDF extends UserDefinedAggregateFunction {
	...
	public StructType inputSchema() {
		return new StructType().
				add("device_category", DataTypes.StringType).
				add("time_spent",DataTypes.LongType).
	...
	public DataType dataType() {
		...
		return new StructType().
				//add("device_distr", DataTypes.createArrayType(DataTypes.createMapType(DataTypes.StringType, DataTypes.FloatType, true)))
				 add("device_distribution", DataTypes.StringType)
				.add("time_spent",DataTypes.LongType)
				.add("video_start",DataTypes.LongType);
